...
public class ExampleTestFunctionBinhKorn implements IGenlabExample {

	public ExampleTestFunctionBinhKorn() {
	}
	...
	public void fillInstance(IGenlabWorkflowInstance workflow) {
		...
		genomeInstance.setName("Binh_Korn");
		...
		geneXInstance.setValueForParameter(DoubleGeneAlgo.PARAM_MINIMUM, 0d);
		geneXInstance.setValueForParameter(DoubleGeneAlgo.PARAM_MAXIMUM, 5d);
		...
		geneYInstance.setValueForParameter(DoubleGeneAlgo.PARAM_MINIMUM, 0d);
		geneYInstance.setValueForParameter(DoubleGeneAlgo.PARAM_MAXIMUM, 3d);
		...
		constantDoubleZero.setValueForParameter(constantDoubleAlgo.getConstantParameter(), 0.0);
	...
	public String getFileName() {
		return "geneticalgo_multigoal_testfunction_binh_korn";
	}

	@Override
	public String getName() {
		return "test function Bink Korn for multi-objective genetic algorithms";
	}

	@Override
	public String getDescription() {
		return "applies NSGA2 on the Binh Korn test function with a display of the Pareto front; enables the checking of the NSGA 2 behaviour";
	}
