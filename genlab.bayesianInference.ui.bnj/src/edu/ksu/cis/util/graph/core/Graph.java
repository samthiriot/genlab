...
public class Graph
{
	 ...
	 * \return the vertex
	 */
	public Vertex get(int theenum)
	{
		if (0 <= theenum && theenum < _VertexCount)
		{
			Vertex T = _VertexStore[theenum].v();
			return T;
		}
		return null;
	}
	 ...
	 */
	public boolean end(int theenum)
	{
		return theenum < _VertexCount && theenum >= 0;
	}
