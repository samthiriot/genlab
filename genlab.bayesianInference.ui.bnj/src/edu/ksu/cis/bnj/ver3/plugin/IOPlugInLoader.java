...
{
	private static IOPlugInLoader instance = new IOPlugInLoaderForGenlab();
	
	protected ArrayList _importers;
	protected ArrayList _exporters;
	...
	protected IOPlugin getIOPlugin(String jarFile) throws Exception 
	{
