...
public class TestEdgeBetweeness extends AbstractTestMeasure<double[]> {

	public TestEdgeBetweeness(IGraphLibImplementation lib) {
		super(lib);
	...
	protected double[] applyMeasure(IGenlabGraph graph,
		...
		return lib.computeEdgeBetweenessEstimate(graph, graph.getDirectionality()==GraphDirectionality.DIRECTED, 0.1, exec);
	}
