...
public class TestGiantCluster extends AbstractTestMeasure<Integer> {

	public TestGiantCluster(IGraphLibImplementation lib) {
		super(lib);
	...
	protected Integer applyMeasure(IGenlabGraph graph,
		...
		return lib.computeGiantCluster(graph, exec);
	}
