...
public class TestERGNMUndirected extends AbstractTestGenerator {

	public TestERGNMUndirected(IGraphLibImplementation lib) {
		super(
				lib, 
	...
	protected IGenlabGraph generateGraph(Long seed, IGraphLibImplementation lib, IExecution exec) {
		return lib.generateErdosRenyiGNM(1000, 1000, true, false, exec, seed);
	}
