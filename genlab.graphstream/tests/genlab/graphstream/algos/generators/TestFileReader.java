...
public class TestFileReader {
	...
	public void test1() {
		...
		GraphStreamDGSParser algo = new GraphStreamDGSParser();
		...
		IAlgoExecution execution = instance.execute(
				new HashMap<IInputOutput, Object>() {{
					put(GraphStreamDGSParser.PARAM_FILE, new File("test.toto"));
				}}
		);
		...
		IGenlabGraph graph = (IGenlabGraph) res.getResults().get(GraphStreamDGSParser.OUTPUT_GRAPH);
